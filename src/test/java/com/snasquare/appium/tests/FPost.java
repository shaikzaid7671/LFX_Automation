...
public class FPost {
    ...
    @Test
    public void AutomatedFPosttest() {
        ...
        /* ---------------- OPEN FOUND POST PAGE ---------------- */
        WebElement FoundBtn = wait.until(
                ExpectedConditions.elementToBeClickable(
                        By.xpath("//android.widget.Button[@content-desc=\"POST FOUND ITEM\"]")
                )
        );
        FoundBtn.click();

        System.out.println("🚨 FoundPost Page Opened");
        ...
        Itemdtls.sendKeys("Watch on Road");
        ...
        AMD.sendKeys("I have Found a Watch in Andhra Pradesh Nellore in Kotamitta Shadi Manzil Road");
        ...
        WebElement cityField = wait.until(
                ExpectedConditions.elementToBeClickable(
                        By.xpath("(//android.widget.EditText[@resource-id=\"text-input-outlined\"])[2]")
                )
        );
        ...
        WebElement Cloc = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//android.widget.TextView[@resource-id=\"button-text\" and @text=\"Current\"]")
        ));
